...
const MenuDropdown = () => {
    ...
    const isBlessedConsciousness = pathname === '/';
    const isMeditation = pathname.includes('/meditation/');
  ...
  return (
    <>
        ...
        <div className={`fixed top-0 left-0 bottom-0 right-0`} style={{ zIndex: '-1' }} ref={overlayRef} onClick={overlayClick}></div>
    </>
  )
}
