...
const TotalCountStat = () => {
  ...
  return (
    <>
        ...
        <div className='grid grid-cols-1 min-[400px]:grid-cols-2 min-[600px]:grid-cols-3 grid-flow-row gap-4 font-open-sans'>
            {
                userDoc?.activities && (
                    userDoc?.activities?.map(activity => {
                        ...
                        return (
                            <div className="stats shadow bg-base-300" key={activityName}>
                                <div className="stat">
                                    <div className="stat-title">{ activityName }</div>
