...
const PickYourMeditation = () => {
  ...
  const [ selectedMeditationAudios, setSelectedMeditationAudios ] = useState([]);
  ...
  return (
    <div className="w-full flex flex-col gap-2.5">
        ...
        <div className="flex flex-col justify-center gap-3 items-stretch sm:flex-row text-nowrap flex-wrap" onClick={meditationTypeClickHandler}>
          <div className={`${meditationTypeClasses} ${ selectedMeditation === 1 && outlineClasses } bg-[#e11d48]`}>Well Being</div>
